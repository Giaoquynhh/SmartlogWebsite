  ...
  return (
    <section id="products" className="bg-white py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-6">
        <h2 className="text-2xl sm:text-3xl lg:text-[36px] font-bold text-[#0b1320] text-center leading-tight">
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <img
                  src={p.iconSrc}
                  alt={p.code}
                  className="w-16 h-16 lg:w-[72px] lg:h-[72px] flex-shrink-0"
                />
              ...
              <h3 className="mt-5 text-lg lg:text-xl font-bold text-[#0b1320] leading-snug">
                {p.title}
              </h3>
              ...
              <button className="mt-5 self-start inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[#1e3a8a] text-[#1e3a8a] text-sm font-semibold hover:bg-[#1e3a8a] hover:text-white transition-colors">
                Xem thêm
